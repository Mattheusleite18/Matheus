...
💡 **Analista de Dados | Data Analytics | Engenharia de Dados em Saúde**
...
* Automação de processos com **Power Platform (Power Automate / Power Apps)**
...
* Data Analytics aplicado à saúde
...
Experiência com dados de sistemas hospitalares como **DBAMV**, incluindo:
...
* Rentabilidade e gerenciamento de Custos
* Protocolos Assistências
* Gestão de Leitos
...
⭐ **Transformando dados em inteligência para a gestão da saúde.**
